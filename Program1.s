...
main:
    ...
    BL  _scanf1             @ branch to scanf1 procedure with return
    MOV R4, R0              @ move return value R0 to argument register R4

    BL  _prompt2            @ branch to prompt2 procedure with return
    BL  _scanf2             @ brach to scanf2 procedure with return
    MOV R5, R0              @ move return value R0 to argument register R5

    BL  _prompt3            @ branch to prompt3 procedure with return
    BL  _scanf3             @ branch to scanf3 procedure with return
    ...
    MOV R1, R0
    BL  _ans                @ branch to answer procedure with return
...
_prompt3:
    ...
    LDR R1, =prompt_str3    @ string at label prompt_str3:
    SWI 0                   @ execute syscall
    MOV PC, LR              @ return
